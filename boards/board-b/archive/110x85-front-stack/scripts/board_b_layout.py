...
WIDTH, HEIGHT = 110, 85
P1_CENTER = (40, 1.8)
MOUNTING_HOLES = [(4,4),(4,23),(32.6,12.8),(106,4),(4,81),(106,81)]
FIDUCIALS = [(9.5,6),(107,27),(18,80)]
PLACEMENTS = {
 'J5':(37.7,12.9,270),'P1':(*P1_CENTER,0),
...
PLACEMENTS.update({'C5':(7,34,90),'R1':(40.5,9,90),'C46':(16,7.5,180),'R2':(41,11.75,0),
...
def pd_to_board_b(point):
    # Face the module toward Board B on its front side; USB remains at the left edge.
    x,y=point
    return (y,x)
