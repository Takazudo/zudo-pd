...
# Copy cleaned SVGs to documentation public directory
cp images/*.svg ../doc/public/footprint-svg/
```
...
```bash
cd /Users/takazudo/repos/personal/zudo-pd/doc/public/footprint-svg
...
3. Verify file was copied to `doc/public/footprint-svg/`
...
cd ../doc
pnpm dev
# Open browser to http://localhost:3800/pj/zudo-pd/docs/components
```

## Next Steps

- [View Footprint Preview](../misc/footprint-preview.mdx) - See all footprints in the documentation
