...
with schemdraw.Drawing(
    ...
    # Save to doc/public/circuits/
    import os
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_path = os.path.join(script_dir, '../doc/public/circuits/buck-u2-diagram.svg')
    d.save(output_path)
...
# Output: SVG saved to doc/public/circuits/buck-u2-diagram.svg
```
...
│   └── src/
│       └── components/
│           ├── circuit-svg.astro   # Click-to-enlarge component
│           └── circuit-dialog.tsx  # Fullscreen dialog
```
...
- Allows HTML container background to show through
- Black lines and text are visible on light container backgrounds
- Works seamlessly with web-based documentation (Astro)
...
- Background color: uses `--color-bg` design token
...
# 5. Verify SVG output
ls -l doc/public/circuits/buck-u2-diagram.svg

# 6. Test in documentation
cd /Users/takazudo/repos/personal/zudo-pd/doc
pnpm dev
# Open: http://localhost:3800/pj/zudo-pd/docs/components/lm2596s-adj

# 7. Commit both Python source and SVG
git add diagram-sources/buck-u2-diagram.py
git add doc/public/circuits/buck-u2-diagram.svg
