...
- **Upstream**: LM2596S-ADJ #3 (U4) - Provides -13.5V input
- **Upstream**: ICL7660M/TR (U5) - Voltage inverter creating negative voltage
- **Downstream**: Protection circuit (PTC3, F3, TVS3)
- **Parallel regulators**: L7812CV-DG (U6), L7805ABD2T-TR (U7)
...
- Related documentation: `/doc/docs/inbox/circuit-diagrams.md` - Diagram8
