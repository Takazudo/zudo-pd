...
```
+5V (from U7) ───┬─── PTC2: 0.75A ──┬─── F2: 1.5A ──┬─── TVS2: PRTR5V0U2X ──┬─→ +5V OUT
                 │  (Auto-Reset)    │   (Backup)    │   (5.5V Clamp)        │
                 │                  │               │      ↕                │
                 │                  │               └─────GND────────────────┤
                 │                  │                                       │
...
3. **Overvoltage**: TVS2 clamps transients above 5.5V (bidirectional)

**Note**: The TVS2 (PRTR5V0U2X) is bidirectional, providing protection against both positive and negative transients.
...
- Related documentation: `/doc/docs/inbox/circuit-diagrams.md` - Diagram7
