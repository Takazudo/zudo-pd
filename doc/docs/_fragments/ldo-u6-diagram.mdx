...
- Layer 1: LM7812 current limiting (~2.2A max, immediate) ✅
- Layer 2: LM7812 thermal shutdown (150°C, 1-5s) ✅
- Layer 3: PTC1 trips (>3A, 0.5-5s) → Auto-reset after 30-60s ✅
- Layer 4: USB-PD adapter protection (backup) ✅

**Components:**
- **PTC1**: C7529589 (SMD1210P150TF/16) - 1.5A hold, 3A trip, SMD1210
- **TVS1**: SMAJ15A (unidirectional, 15V) - Cathode to +12V OUT, Anode to GND
- **LED2**: Green LED with R7 (1kΩ) - Status indicator

**Protection Operation:**
- **Normal** (&lt;1.5A): PTC low resistance, LED illuminated
- **Overload** (1.5A-3A): PTC heats up, trips in 1-5s, LED dims/off
- **Short circuit** (&gt;3A): LM7812 current limiting activates immediately, PTC trips in 0.5-5s
