...
```
    ...
    │   │                    │                                          │
    │   │  VBUS_VS_DISCH ────┼── R_VS (470Ω) ── VBUS_IN                │
    │   │  (pin 18)          │                                          │
    │   │                    │                                          │
    │   │  ADDR0 (pin 12) ───┼── GND                                    │
    │   │  ADDR1 (pin 13) ───┼── GND                                    │
...
STUSB4500 (QFN-24) - USB-IF Certified PD Sink Controller:
    ...
    RESET   6 │── GND (or NC)                    19│ ALERT (NC)
      SCL   7 │── NC (or I2C)                     18│ VBUS_VS_DISCH ── R_VS (470Ω) ── VBUS_IN
...
│ VBUS_VS_DISCH (18) │ R_VS (470Ω) to VBUS_IN (voltage sense/discharge) │
