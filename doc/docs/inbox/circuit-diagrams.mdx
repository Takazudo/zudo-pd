...
Input Capacitors (place C14 CLOSEST to IC pin 1):
+13.5V ──┬─── To IC Pin 1
         │
         ├─ C14 (470nF ceramic) ※ CLOSE to IC pin
         │    │
         │   GND
         │
         └─ C20 (470µF electrolytic) ※ Can be farther
              │
             GND

Output Capacitors (place C17 CLOSEST to IC pin 3):
+12V ────┬─── From IC Pin 3
         │
         ├─ C17 (100nF ceramic) ※ CLOSE to IC pin
         │    │
         │   GND
         │
         └─ C21 (470µF electrolytic) ※ Can be farther
              │
             GND
...
- All capacitors are in PARALLEL (between rail and GND), NOT in series with power path
...
Input Capacitors (place C15 CLOSEST to IC pin 1):
+7.5V ───┬─── To IC Pin 1
         │
         ├─ C15 (470nF ceramic) ※ CLOSE to IC pin
         │    │
         │   GND
         │
         └─ C22 (470µF electrolytic) ※ Can be farther
              │
             GND

Output Capacitors (place C18 CLOSEST to IC pin 3):
+5V ─────┬─── From IC Pin 3
         │
         ├─ C18 (100nF ceramic) ※ CLOSE to IC pin
         │    │
         │   GND
         │
         └─ C23 (470µF electrolytic) ※ Can be farther
              │
             GND
...
Input Capacitors (place C16 CLOSEST to IC pin 1):
-13.5V ──┬─── To IC Pin 1
         │
         ├─ C16 (470nF ceramic) ※ CLOSE to IC pin
         │    │
         │   GND
         │
         └─ C24 (470µF electrolytic) ※ Can be farther
              │  ※ Polarity: - to -13.5V, + to GND
             GND

Output Capacitors (place C19 CLOSEST to IC pin 2):
-12V ────┬─── From IC Pin 2
         │
         ├─ C19 (100nF ceramic) ※ CLOSE to IC pin
         │    │
         │   GND
         │
         └─ C25 (470µF electrolytic) ※ Can be farther
