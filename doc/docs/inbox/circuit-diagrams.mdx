...
Flying Capacitor C12 (connects separately):
                 ┌───────────┐
Pin 2 (CAP+) ────┤           ├──── Pin 4 (CAP-)
                 │ C12 (10µF)│
                 │  Ceramic  │
...
NOTE: C12 connects ONLY between Pin 2 (CAP+) and Pin 4 (CAP-)
