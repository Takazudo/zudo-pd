...
flowchart TD
    ...
    D4["Voltage Inverter U5
    +15V to -15V
    Diagram4"]

    D5["Buck Converter U4
    -15V to -13.5V
    Diagram5"]

    D6["Linear Regulator U6
    +13.5V to +12V
    Diagram6"]

    D7["Linear Regulator U7
    +7.5V to +5V
    Diagram7"]

    D8["Linear Regulator U8
    -13.5V to -12V
    Diagram8"]
...
- **-12V rail**: USB-C 15V → Inverter (U5) → Buck (U4) → LDO (U8) → -12V OUT
