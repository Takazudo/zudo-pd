...
negative range to 13.484–14.814 V, retaining 0.484 V before ripple and wiring loss. A 10.6 kΩ top resistor raises the nominal magnitude to 14.268 V and the lower
bound to 13.663 V, with slightly more dissipation.
...
At the 10.5 kΩ scenario's maximum input and the LT3015's minimum output magnitude,
series-pass loss is about 2.39 W. Ground-pin current increases with load: the
published 1.5 A/dropout maximum of 70 mA adds about 1.03 W as a conservative screening
case. It is not an interpolated guarantee at 0.8 A. The resulting 3.42 W screen
requires effective junction-to-ambient thermal resistance below about 24.8 °C/W
at 40 °C ambient to remain below 125 °C. The filled copper areas are not a
thermal qualification; actual layout, shared heat paths and temperature rise must
be verified. The 14 °C/W headline DD-Pak value uses a specific 2500 mm² test board
...
checks connectivity and sampled ground-return width; neither area nor via count
