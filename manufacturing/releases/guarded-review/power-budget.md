...
The guarded 110 × 85 mm board removes a further 10 mm of height from the 110 × 95 mm
layout while retaining the components and load targets. The rotated PD stack and
underside Faston guard change the physical arrangement and airflow. Use the
current source-locked filled areas in the JSON reports; earlier layouts and
manufacturer single-device test boards cannot qualify this assembly's coupled
temperatures. Repeat full-load thermal measurements with the guard and final
mating cables installed.
