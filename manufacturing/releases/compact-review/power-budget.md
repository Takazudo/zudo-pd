...
The 110 × 95 mm compact board has less tab-connected heat-spreading copper around
U8 than the earlier 150 × 115 mm layout. This tradeoff does not reduce the retained
load targets or the conditioned dissipation screen. Use the current source-locked
filled areas in the JSON reports; the larger layout's copper and manufacturer
single-device test boards cannot qualify the compact board's coupled temperatures.
