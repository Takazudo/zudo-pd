...
P1_CENTER = (60, 1.8)
PD_OFFSET = (-0.5, 12)
MOUNTING_HOLES = [(3.5,16),(3.5,35),(32.1,24.8),(106,4),(4,81),(106,81),(4,4)]
SUPPORT_REFS = {'H4','H5','H6','H7'}
POGO_LEGEND_CENTER = (88, 2)
FIDUCIALS = [(9.5,6),(107,27),(18,80)]
PLACEMENTS = {
 'J5':(37.2,24.9,270),'P1':(*P1_CENTER,0),
 'J6':(7,48,90),'J7':(7,61,90),
 ...
 'R26':(82.6,62.3,90),'R27':(82.6,58.9,90),'R28':(81.85,56.2,0),
...
PLACEMENTS.update({'C5':(18,6,0),'R1':(40.5,9,90),'C46':(28,6.5,180),'R2':(41,11.75,0),
                   'C21':(99,18,90),'PTC1':(100.5,6.5,90),'TVS1':(108,17.5,90),
                   'R22':(92,9,0),'C32':(26,22,0),'R3':(26,29,180),'R4':(26,26,90),'D2':(33.75,35,90),
                   'C3':(57.7,9,90),'C14':(57.7,15.5,90),'C20':(57.7,22,90),
                   'C36':(62.3,9,90),'C37':(62.3,15.5,90),'TP3':(66.35,1.8,0),'TP4':(68.89,1.8,0),'TP5':(71.43,1.8,0)})
...
def pd_to_board_b(point):
    # Face the module toward Board B; free the top-left support and keep USB accessible.
    x,y=point
    return (y+PD_OFFSET[0],x+PD_OFFSET[1])
